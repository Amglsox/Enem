...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 16 11:07:52 2020
...
#def main():
basePath = os.getcwd()+'/dados'
path = [basePath,'raw','MICRODADOS*.csv']
sep = '/'
pathRaw = sep.join(path)
read_file(pathRaw)
lista_columns = read_metadata(basePath)
spark.sql("SELECT {} FROM df_enem".format(lista_columns)).createOrReplaceTempView('df_enem')
